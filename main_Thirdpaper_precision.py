...
def main():
    ...
    model = UNetGenerator(input_channels=3, output_channels=12)
...
###################################################################################
                ...
                if (cur_itrs) % opts.val_interval == 0:
                    ...
                    save_ckpt('F:/Third_paper/Checkpoint/Segmentation/SegGAN/CamVid_Firstfold/Original/Standard_UNet_generator/generator/latest_%s_%s_os%d.pth' %
                              (opts.model, opts.dataset, opts.output_stride))
                    print("validation...")
                    model.eval()
                    val_score, ret_samples = validate(
                    ...
                    if val_score['Mean IoU'] > best_score:  # save best model
                        ...
                        #           (opts.model, opts.dataset,opts.output_stride))
                        save_ckpt('F:/Third_paper/Checkpoint/Segmentation/SegGAN/CamVid_Firstfold/Original/Standard_UNet_generator/generator/best_%s_%s_os%d.pth' %
                                  (opts.model, opts.dataset, opts.output_stride))
                    ...
                    save_ckpt('F:/Third_paper/Checkpoint/Segmentation/SegGAN/CamVid_Firstfold/Original/Standard_UNet_generator/generator/_%s_%s_%s_os%d.pth' %
